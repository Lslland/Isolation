...
from fl_api.standalone.FedAvg.fedavg_api import FedAvgAPI
...
if __name__ == "__main__":
    ...
    log_name = "FedAvg_AckRatio{}_{}_data{}_alpha{}_epoch{}_inject{}_agg{}_nonIID{}_theta{}_attack{}_topk{}".format(
        args.num_corrupt, args.num_clients, args.dataset, args.alpha, args.epochs,
    ...
    print("{}".format(args))
    mnt_flAPI = FedAvgAPI(dataset, device, args, logger)
    mnt_flAPI.train()
