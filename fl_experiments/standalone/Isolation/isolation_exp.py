...
sys.path.insert(0, os.path.abspath("/home/lgz/papers/federated_learning_20231222/codes/migitive_negative_transfer_v2/"))
from fl_api.standalone.Isolation.isolation_model_trainer import MyModelTrainer
from fl_api.standalone.Isolation.isolation_api import IsolationAPI
