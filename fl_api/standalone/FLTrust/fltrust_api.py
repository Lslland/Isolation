...
from fl_api.standalone.FLTrust.fltrust_client import Client
...
from fl_api.standalone.FLTrust.fltrust_model_trainer import MyModelTrainer
from fl_api.standalone.FLTrust.fltrust_aggregation import Aggregation
...
class FLTrustAPI:
    ...
    def train(self):
        ...
        for round_idx in range(1, self.args.comm_round+1):
            ...
            for client_id in client_indexes:
                ...
                update, client_params = client.train(copy.deepcopy(w_global), round_idx, self.criterion)
    ...
    def test(self, global_model, round_idx):
        ...
        val_loss, (val_acc, val_per_class_acc), _ = self.get_loss_n_accuracy(global_model, self.criterion, self.val_loader,
