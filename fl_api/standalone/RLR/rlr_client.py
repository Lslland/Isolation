...
class Client:
    ...
    def train(self, w, round_idx, neurotoxin_mask=None):
        ...
        update, channel_sign_dict, conv_last_weights = self.model_trainer.train(self.train_loader, self.device, round_idx, neurotoxin_mask, self.poison_idxs)
        return update, channel_sign_dict, conv_last_weights
