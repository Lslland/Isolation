...
from fl_api.standalone.RFA.rfa_client import Client
...
from fl_api.standalone.RFA.rfa_model_trainer import MyModelTrainer
from fl_api.standalone.RFA.rfa_aggregation import Aggregation
