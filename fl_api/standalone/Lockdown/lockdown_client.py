...
class Client:
    ...
    def __init__(self, client_idx, args, device, model_trainer, train_dataset, logger, data_idxs, mask=None):
        self.logger = logger
    ...
    def train(self, w, round_idx, criterion, global_mask=None, neurotoxin_mask=None):
        ...
        updates, self.mask = self.model_trainer.train(self.train_loader, self.device, round_idx, criterion,
                                                      global_mask=global_mask, neurotoxin_mask=neurotoxin_mask)
