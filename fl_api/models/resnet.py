...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, track_running_stats=False):
    ...
    def _make_layer(self, block, planes, num_blocks, stride, track_running_stats):
        ...
        for stride in strides:
            layers.append(block(self.in_planes, planes, stride, track_running_stats=track_running_stats))
...
def ResNet18(num_classes):
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, track_running_stats=False)
